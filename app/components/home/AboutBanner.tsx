    ...
    <section className="relative py-0 bg-[#0A0A0A] overflow-hidden">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 items-stretch">
        <div className="relative w-full h-full min-h-[400px] lg:min-h-[520px] overflow-hidden group">
          <div className="absolute inset-0 bg-cover bg-center bg-no-repeat transition-transform duration-[1.8s] group-hover:scale-105"
            style={{ backgroundImage: `url('${page?.heroImage || "https://images.unsplash.com/photo-1585747860715-2ba37e788b70?q=80&w=1200&auto=format&fit=crop"}')` }} />
          <div className="absolute inset-0 bg-black/30" />
        </div>
        <motion.div initial={{ opacity: 0, x: 40 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true, margin: "-80px" }}
          transition={{ duration: 1.1, ease: [0.16, 1, 0.3, 1] }} className="flex flex-col justify-center px-10 md:px-16 lg:px-20 py-12 md:py-16 bg-[#0E0E0E] text-white">
