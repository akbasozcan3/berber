...
export function buildAppointmentCancelledSubject(data: AppointmentCancelledEmailData): string {
  ...
  return `${data.businessName}: Randevu iptali ${dateLabel} ${data.time}`;
}
...
export function buildAppointmentCancelledHtml(data: AppointmentCancelledEmailData): string {
  ...
  const bookingUrl = siteLink ? `${siteLink}/randevu` : "";
        ...
        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:560px;background:#FFFFFF;border:1px solid #E5E7EB;">
          <tr>
            <td style="padding:28px 28px 20px;text-align:center;border-bottom:1px solid #EEEEEE;">
              ...
              <p style="margin:12px 0 0;font-size:12px;color:#6B7280;">Randevu iptali</p>
            </td>
          </tr>
          <tr>
            <td style="padding:28px;">
              ...
              <p style="margin:0 0 22px;font-size:14px;line-height:1.7;color:#4B5563;">
                Aşağıdaki randevunuz iptal edilmiştir. İlgili saat tekrar müsait hale getirilmiştir.
              </p>
              <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="border:1px solid #E5E7EB;">
                ...
                <tr>
                  <td style="padding:12px 14px;font-size:13px;color:#6B7280;">Saat</td>
                  <td style="padding:12px 14px;font-size:14px;color:#111827;">${escapeHtml(data.time)}</td>
                </tr>
              </table>
              ...
              <p style="margin:20px 0 0;font-size:13px;line-height:1.7;color:#6B7280;">
                Yeni randevu için${bookingUrl ? ` <a href="${escapeHtml(bookingUrl)}" style="color:#111827;">${escapeHtml(siteHost || "sitemiz")}/randevu</a>` : " salonumuzla iletişime geçebilirsiniz"}.
              </p>
            </td>
          </tr>
          <tr>
            <td style="padding:18px 28px 24px;border-top:1px solid #EEEEEE;background:#FAFAFA;">
              ...
              <p style="margin:10px 0 0;font-size:11px;color:#9CA3AF;">
                Bu bilgilendirme e-postası randevu iptali için otomatik gönderilmiştir.
              </p>
            </td>
          </tr>
        </table>
...
export function buildAppointmentCancelledText(data: AppointmentCancelledEmailData): string {
  ...
  lines.push("", "Yeni randevu için salonumuzla iletişime geçebilirsiniz.", "", data.businessName);
  return lines.join("\n");
}
